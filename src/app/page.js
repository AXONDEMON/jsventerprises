...
const Home = () => {
  ...
  return (
    <main className={styles.main}>
      <div className={`slider-container ${styles.sliderWrapper}`} ref={sliderRef}>
        {/* Section 1: Hero */}
        ...
        {/* Section 2: Welcome */}
        <section id="welcome" className="slide section container">
        ...
        {/* Section 3: Process */}
        <section id="process" className={`slide ${styles.processSection} section`}>
        ...
        {/* Section 4: Partners */}
        <section id="partners" className={`slide ${styles.partnersSection}`}>
          <div className="container">
        ...
        <section id="infrastructure" className={`slide ${styles.parallaxSection}`}>
        ...
        {/* Section 6: Products */}
        <section id="products" className="slide section container">
        ...
        {/* Section 7: Gallery */}
        <section id="gallery" className={`slide ${styles.gallerySection}`}>
          <div className="container">
        ...
        {/* Section 8: CTA */}
        <section id="cta" className={`slide ${styles.ctaSection}`}>
          <div className="container">
